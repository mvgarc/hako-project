...
function Providers() {
  ...
  const onSubmit = async (data: ProviderForm) => {
    ...
    try {
      ...
      reset();
      setShowForm(false); // Ocultar formulario tras crear proveedor
    } catch (err) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-md space-y-6">
      ...
      {showForm && (
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
            ...
            <Button type="submit" className="mt-4" disabled={loadingSubmit}>
              {loadingSubmit ? 'Guardando...' : 'Guardar Proveedor'}
            </Button>
          </form>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        {loadingProviders && <p>Cargando proveedores...</p>}
                  ...
                  <tr key={prov.id}>
                    ...
                    <td className="px-4 py-2">
                      <a
                        ...
                        aria-label={`Sitio web de ${prov.name}`}
                      >
                        {prov.website}
                      </a>
                    </td>
